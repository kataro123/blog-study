                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: rgb(56, 56, 56); text-align: left;" valign="top" align="left">
                                                                                                                        <div style="line-height: 150%; text-align: center;"><span style="font-size: 16px; font-family: 'Arial Black', 'Arial Bold', sans-serif; color: #2c2929; line-height: 150%;">Ola, <?= $name ?>. Você recebeu um novo email de <?= $from ?></span></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: rgb(56, 56, 56); text-align: left;" valign="top" align="left">
                                                                                                                        ...
                                                                                                                        <div style="line-height: 200%; text-align: center;"><span style="font-family: 'Arial Black', 'Arial Bold', sans-serif; font-size: 36px; color: #ffffff; line-height: 200%;"><?= $subject ?></span><br><br><span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 200%;"><?= nl2br($message) ?></span></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
