                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <form method="post" action="<?= url_to('login.store') ?>">
                                    ...
                                    <div class="form-outline mb-4">
                                        <span class="text-danger"><?= session()->get('errors')['password'] ?? '' ?></span>
                                        <input type="password" name="password" value="123" id="form2Example22" class="form-control" />
                                    ...
                                    <div class="d-flex align-items-center justify-content-center pb-4">
                                        ...
                                        <a href="<?= url_to('register') ?>" type="button" class="btn btn-outline-danger">Create new</a>
                                    </div>
